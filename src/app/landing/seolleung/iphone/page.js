...
export const metadata = {
  title: "강남·선릉 아이폰수리 | 아이스마일어게인 선릉점",
  description:
    "강남·선릉 아이폰 액정, 배터리, 카메라, 충전불량, 후면유리, 침수 수리 상담. 선릉역 1번 출구 1분 아이스마일어게인 선릉점.",
  robots: {
    index: false,
    follow: true,
  },
...
const symptoms = [
  {
    image: "/images/landing/iphone/screen-damage.webp",
    title: "액정 · 화면 파손",
    text: "화면 깨짐 · 터치 불량 · 화면 이상",
  },
  {
    image: "/images/landing/iphone/battery.webp",
    title: "배터리 교체",
    text: "빠른 방전 · 전원 꺼짐 · 성능 저하",
  },
  {
    image: "/images/landing/iphone/camera.webp",
    title: "카메라 수리",
    text: "카메라 떨림 · 초점불량 · 렌즈 파손",
  },
  {
    image: "/images/landing/iphone/charging-backglass.webp",
    title: "충전불량 · 후면유리",
    text: "충전불량 · 접촉불량 · 후면유리 파손",
  },
  {
    image: "/images/landing/iphone/water-damage.webp",
    title: "침수 · 물 접촉",
    text: "침수 · 습기유입 · 전원 이상",
  },
  {
    image: "/images/landing/iphone/other-fault.webp",
    title: "기타 아이폰 고장",
    text: "전원 · 부팅 · 기타 증상",
  },
];
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.title}>
              강남·선릉{" "}
              <span className={styles.titleBlue}>아이폰</span>수리
            </h1>
            ...
            <div className={styles.onlineActionWrap}>
              <Link
                href="/contact?branch=seolleung&device=iphone"
          ...
          <div className={styles.heroVisual}>
            <img
              src="/images/landing/iphone/hero-iphone-repair.webp"
              alt="아이폰을 정밀 수리하는 아이스마일어게인 수리기사"
      ...
      <section id="seolleung-map" className={styles.branchSection}>
        <div className={styles.branchWrap}>
          ...
          <div className={styles.branchMapCard}>
            <img
              src="/images/landing/iphone/seolleung-map.svg?v=2"
              alt="아이스마일어게인 선릉점 약도"
      ...
      <section className={styles.caseSection}>
        ...
        <div className={styles.casePreviewGrid}>
          <Link href="/repair-services/iphone" className={styles.casePreviewCard}>
            <div className={styles.casePreviewImage}>
              <img
                src="/images/landing/iphone/screen-damage.webp"
                alt="아이폰 액정 파손 수리"
              />
            </div>
            <div>
          ...
          <Link href="/repair-services/iphone" className={styles.casePreviewCard}>
            <div className={styles.casePreviewImage}>
              <img
                src="/images/landing/iphone/battery.webp"
                alt="아이폰 배터리 교체"
              />
            </div>
            <div>
          ...
          <Link href="/repair-services/iphone" className={styles.casePreviewCard}>
            <div className={styles.casePreviewImage}>
              <img
                src="/images/landing/iphone/camera.webp"
                alt="아이폰 카메라 수리"
              />
            </div>
            <div>
              <span>카메라 수리</span>
              <strong>떨림 · 초점불량 · 렌즈파손</strong>
              <small>아이폰 카메라 수리사례 보기 →</small>
            </div>
          </Link>
        </div>
      </section>
