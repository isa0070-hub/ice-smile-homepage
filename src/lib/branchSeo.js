...
export const branchSeo = deepFreeze({
  gangbyeon: {
    ...
    businessHours: {
      weekdays: "월요일~토요일 10:30~19:00",
      closed: "매주 일요일·공휴일 및 매월 둘째·넷째 화요일 휴무",
    },
    ...
    visitAreas: [
      {
        name: "잠실",
        description:
          "잠실역에서는 지하철 2호선으로 강변역까지 이동한 뒤 1번 출구 쪽 강변테크노마트로 오시면 됩니다. 매장은 5층 B구역 20호에 있습니다.",
      },
      {
        name: "건대입구",
        description:
          "건대입구역에서는 지하철 2호선을 이용해 강변역에서 내리세요. 강변테크노마트 5층에서 B구역 표지판을 따라 20호로 방문하시면 됩니다.",
      },
      {
        name: "성수",
        description:
          "성수역에서는 지하철 2호선으로 강변역까지 이동할 수 있습니다. 성수에 별도 매장이 있는 것은 아니며, 수리 상담과 방문 접수는 강변테크노마트 5층 B구역 20호에서 진행합니다.",
      },
    ],
    services: [
      "아이폰 액정 및 배터리 수리",
  ...
  seolleung: {
    ...
    description:
      "강남 아이폰·아이패드 수리 상담은 선릉역 1번 출구 인근 샹제리제센터 A동 406호 아이스마일어게인 선릉점. 액정·배터리·충전 불량 점검, 평일 10:30~19:30 운영. 매장 등록 시 1시간 무료주차(차량 높이 2.3m 제한).",
    intro:
    ...
    visitAreas: [
      {
        name: "선릉",
        description:
          "선릉역 1번 출구에서 나와 바로 옆 샹제리제센터 A동 406호로 방문하시면 됩니다.",
      },
      {
        name: "역삼",
        description:
          "역삼역과 테헤란로 업무지구에서는 지하철 2호선으로 선릉역까지 이동한 뒤 1번 출구를 이용할 수 있습니다.",
      },
      {
        name: "강남",
        description:
          "강남역 일대에서는 지하철 2호선으로 선릉역까지 이동해 1번 출구로 나오면 매장을 찾기 편리합니다.",
      },
      {
        name: "삼성",
        description:
          "삼성역과 코엑스 일대에서는 지하철 2호선으로 선릉역까지 이동하거나 테헤란로를 따라 방문할 수 있습니다.",
      },
      {
        name: "대치",
        description:
          "대치동에서는 출발 위치에 따라 선릉역 방면 대중교통을 이용한 뒤 1번 출구에서 방문할 수 있습니다.",
      },
      {
        name: "선정릉",
        description:
          "선정릉역에서는 수인분당선으로 선릉역까지 이동한 뒤 1번 출구를 이용할 수 있습니다.",
      },
    ],
    services: [
      "아이폰 액정 및 배터리 수리",
    ...
    nearbyAreas: ["강남", "역삼동", "선릉", "삼성동", "대치동", "선정릉"],
  },
